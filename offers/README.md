...
An _offer_ is a proposed travel package you can send to a customer (or prospect), follow up on, and—if accepted—convert into a booking.
...
<figure><img src="../.gitbook/assets/image (2) (1) (1) (1) (4).png" alt="Offers overview"><figcaption><p>Offers overview with filters, results list, and actions.</p></figcaption></figure>
...
* **Status**: Show offers in a specific state (for example _Unsent_, _Available_, _Expired_, _Sold_, _Closed_).
...
{% hint style="info" %}
If you’re looking for what to work on today, start with **Status = Unsent/Available** and set a **Follow-up** date range.
{% endhint %}
...
{% hint style="warning" %}
Deleting an offer removes it from the list. Only delete offers if your company process allows it and you are sure it is no longer needed.
{% endhint %}
...
<table data-view="cards"><thead><tr><th>Topic</th><th data-card-target data-type="content-ref">Read more</th></tr></thead><tbody><tr><td>Create a new offer</td><td><a href="create-new-offer.md">create-new-offer.md</a></td></tr><tr><td>Offer list + statistics</td><td><a href="offer-management-and-statistics.md">offer-management-and-statistics.md</a></td></tr><tr><td>Offer templates</td><td><a href="offer-template.md">offer-template.md</a></td></tr><tr><td>Insert reusable text into offers</td><td><a href="select-text-for-offers.md">select-text-for-offers.md</a></td></tr><tr><td>SMS templates</td><td><a href="customer-offer-sms-template.md">customer-offer-sms-template.md</a></td></tr><tr><td>Automatic offer flow</td><td><a href="customer-offer-automatic-flow.md">customer-offer-automatic-flow.md</a></td></tr></tbody></table>
