...
<figure><img src="../.gitbook/assets/ebd_hc.png" alt=""><figcaption></figcaption></figure>
...
| **Deposit Date**        | <p>Date when the deposit must be paid for bookings using this discount. </p><p><mark style="color:$danger;">Note: Payment of Early Booking Discount on all bookings agreed on this date. Deposit date must be equal or greater than booking end date</mark></p> |
