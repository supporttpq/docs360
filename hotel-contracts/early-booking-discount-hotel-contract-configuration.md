...
| **Deposit Date**        | <p>Date when the deposit must be paid for bookings using this discount. </p><p><mark style="color:$danger;">Note: Deposit date must be equal or greater than booking end date</mark></p> |
