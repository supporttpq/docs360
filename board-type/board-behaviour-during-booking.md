...
When the Board Basis changes, Tourpaq combines a Board Basis with a Board Supplement. The **Bo**[**ard Type** ](./)order determines the board offered. Tourpaq selects the highest ordered Board Type and adds a supplement for days with a lower Board Basis.
...
<figure><img src="../.gitbook/assets/image (205).png" alt="Ticket hotel section showing Pension: Halvpension for a stay booked with a board basis upgrade"><figcaption></figcaption></figure>
