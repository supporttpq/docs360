...
| ----------- | ----------- | ----------------------------------------------- |
| **PENDING** | Brown       | Booking is not yet confirmed                    |
| **HK**      | Pink        | Booking is confirmed (holding confirmed status) |
| **TKOK**    | Light green | Ticketing is confirmed and completed            |
| **OK**      | Dark green  | Booking OK                                      |
| **ERR**     | Yellow      | Error                                           |
| **CXL**     | Red         | Cancelled                                       |
| **TKQ**     | Blue        |                                                 |
...
* Matches it to predefined color
