...
<table><thead><tr><th width="258.5">Field</th><th width="125.25">Type</th><th>Description</th></tr></thead><tbody><tr><td><strong>Display in Remember Extras</strong></td><td>Multi-select</td><td>Controls which brands show this category in “Remember Extras”.</td></tr><tr><td><strong>Use for Extras Statistic</strong></td><td>Multi-select</td><td>Controls which brands include this category in extras statistics.</td></tr><tr><td><strong>Display in Hotel List</strong></td><td>Multi-select</td><td><p>Controls whether an Extra Category is available for specific agencies in the hotel list.</p><p><strong>Behavior:</strong></p><ul><li>If an agency is deselected, the Extra Category is no longer available for that agency in the hotel lists.</li><li>Any extras from this category already added to bookings for that agency are removed from the all hotel lists after the booking is updated.</li></ul><p><strong>Notes:</strong></p><ul><li>The change applies only after the booking is updated.</li><li>Existing bookings are affected only in the Rooming List output, not in the booking data itself.</li></ul></td></tr><tr><td><strong>Hide as filter in list</strong></td><td>Checkbox</td><td>Hides this category as a filter across the system’s lists.</td></tr></tbody></table>
