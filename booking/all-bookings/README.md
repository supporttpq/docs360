...
| **Extra**                        | Filter by Extra and a specific Extra Categories                   | <div><figure><img src="../../.gitbook/assets/image (1) (1) (1) (1).png" alt=""><figcaption></figcaption></figure></div> |
...
| Extras             | <p>List all extras that are associated with a booking.                                                                   </p><p>At mouse-over, a tool-tip is shown, where a table shows how the extras belong to what passenger and the full name of the extras.    The Extras column is available in the column selector. <img src="../../.gitbook/assets/image (2) (1) (1).png" alt=""></p><p> </p> |
