...
2. Click the **E‑mails** tab in the booking details.
...
| Field            | Description                                                                                              |
| ---------------- | -------------------------------------------------------------------------------------------------------- |
| **E‑mail type**  | Describes the type of e‑mail (for example: _Booking confirmation_, _Ticket e‑mail_, _Payment reminder_). |
| **Sent date**    | The exact **date and time** the e‑mail was sent.                                                         |
| **Sent address** | The **e‑mail address** the message was sent to.                                                          |
| **View e‑mail**  | Opens the full e‑mail body, showing the content that was delivered to the customer.                      |
