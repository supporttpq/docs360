...
| To the customer             | Text shown on ticket                                                                                       | Ticket                   | Write text ->Save -> Verify the ticket.                                                                   |
| **Ticket Attachments**      | PDF file attached to the customer’s ticket. Attached files will appear at the end of the printed ticket.   | Customer (on ticket)     | Click Upload Attachments  → Add title →Add the PDF file -> Save → Print ticket to view attachment at end. |
