...
* Select the period to find available transport.
...
Click on the Take Allotment button.

Booking details allow for the editing of passengers' gender, name, and age.
...
Click Add Discounts/Supplement. Here we find all available discounts and supplements for this booking. We can add for each passenger or for all eligible passengers. We can add at the same time more than one supplement and discount.

Click on Save Passenger.

To finish the booking, click on Save.

We can send the ticket email by clicking on the Send Email button, or it will be automatically generated by the system.
