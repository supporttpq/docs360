...
* [New Booking](booking/new-booking/README.md)
  ...
  * [Tee Times](booking/new-booking/tee-times/README.md)
    * [Golf Course Check-In Module](booking/new-booking/tee-times/golf-course-check-in-module.md)
...
* [Hotel Contracts](hotel-contracts/README.md)
  ...
  * [Double as Single – Hotel Contract Configuration](hotel-contracts/double-as-single-hotel-contract-configuration/README.md)
    * [Board Basis Inheritance Rule](hotel-contracts/double-as-single-hotel-contract-configuration/board-basis-inheritance-rule.md)
...
* [Business Intelligence](business-intelligence/README.md)
  ...
  * [Business Intelligence – Accommodation](business-intelligence/business-intelligence-accommodation.md)
...
* [Transport Rules](transport-rules/README.md)
  ...
  * [Edit Transport Rule](transport-rules/edit-transport-rule.md)
...
* [Brands](brands/README.md)
  ...
  * [Service Case Settings](brands/service-case-settings.md)
...
* [Maps](maps.md)
* [Weekly Activities](guest-app/weekly-activities/README.md)
  * [Add Weekly Activity](guest-app/weekly-activities/add-weekly-activity.md)
...
* [Extras - General page](extras-setup/extras-general-page/README.md)
  * [Overview](extras-setup/extras-general-page/extras/README.md)
    * [Prices](extras-setup/extras-general-page/extras/prices.md)
    * [Resources](extras-setup/extras-general-page/extras/resources/README.md)
      * [Add Transport Modes and Transport Types to Extras Resources](extras-setup/extras-general-page/extras/resources/add-transport-modes-and-transport-types-to-extras-resources.md)
    * [Allotments](extras-setup/extras-general-page/extras/allotments.md)
    * [Sold out behaviour](extras-setup/extras-general-page/extras/sold-out-behaviour.md)
    * [Extra package](extras-setup/extras-general-page/extras/extra-package.md)
    * [Attributes](extras-setup/extras-general-page/extras/attributes.md)
    * [Communication](extras-setup/extras-general-page/extras/communication.md)
    * [Package Content](extras-setup/extras-general-page/extras/package-content.md)
    * [Notes](extras-setup/extras-general-page/extras/notes.md)
    * [Early booking/Stay and pay and Special Early Booking/Stay and pay](extras-setup/extras-general-page/extras/early-booking-stay-and-pay-and-special-early-booking-stay-and-pay.md)
    * [Passenger information](extras-setup/extras-general-page/extras/passenger-information.md)
    * [Teetime](extras-setup/extras-general-page/extras/teetime.md)
    * [Multiple product selection in product category](extras-setup/extras-general-page/extras/multiple-product-selection-in-product-category.md)
    * [Create an extra with stay days functionality and select it in bookings](extras-setup/extras-general-page/extras/create-an-extra-with-stay-days-functionality-and-select-it-in-bookings.md)
    * [Gala Dinner](extras-setup/extras-general-page/extras/gala-dinner.md)
...
* [Discount/Supplement General Page](discount-supplement-general-page.md)
* [Discounts/Supplements combination in Tourpaq](discounts-supplements.md)
...
* [Average Pax Per Room Sold](setup/average-pax-per-room-sold.md)
* [System Setup](setup/system-setup/README.md)
  ...
  * [System Setup – Hotel Providers](setup/system-setup/system-setup-hotel-providers/README.md)
    * [SkiStar Sync](setup/system-setup/system-setup-hotel-providers/skistar-sync.md)
