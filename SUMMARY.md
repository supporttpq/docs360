...
* [Hotel creation](hotel/page-7/README.md)
  ...
  * [Allotments per day](hotel/page-7/allotments-per-day/README.md)
    * [Exclusive start date for hotels](hotel/page-7/allotments-per-day/exclusive-start-date-for-hotels.md)
  ...
  * [Room cost](hotel/page-7/room-cost/README.md)
    * [Add room cost rule with "Per Room Per Stay" type](hotel/page-7/room-cost/add-room-cost-rule-with-per-room-per-stay-type.md)
    * [Add room cost rule with "Per Room Per Stay" with a specific stay days value](hotel/page-7/room-cost/add-room-cost-rule-with-per-room-per-stay-with-a-specific-stay-days-value.md)
  ...
  * [Occupancy / Handling](hotel/page-7/occupancy-handling/README.md)
    ...
    * [Single Room Suplement](hotel/page-7/occupancy-handling/single-room-suplement.md)
