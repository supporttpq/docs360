...
Used to sell the same room under different settings and prices.

<figure><img src="../.gitbook/assets/image (14).png" alt=""><figcaption></figcaption></figure>

Two room types are needed in the hotel for this feature. **Warning!** Only the //room above// will have real allotment, the other room taking allotment from this one.
