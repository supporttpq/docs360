...
<table data-header-hidden><thead><tr><th width="210.25"></th><th></th></tr></thead><tbody><tr><td><strong>Field</strong></td><td><strong>Description</strong></td></tr><tr><td><strong>Stay</strong> <strong>Start / End</strong></td><td>Defines the <strong>first stay date/</strong>the <strong>last stay date</strong> for which the Early Booking rule is valid. Bookings with arrival dates <strong>before this date/after this date</strong> will not match the rule. The rule can apply to overlapping stay days. Example: stay 01–07 Oct, rule 05–30 Oct applies on 05–07 Oct.</td></tr><tr><td><strong>Booking Start / End</strong></td><td>Specifies when the booking must be made for the discount to apply.</td></tr><tr><td><strong>Days of the Week</strong></td><td>Restricts the rule to arrivals on selected weekdays. This has to coincide with the arrival date of the booking. If no value is selected, the rule applies to <strong>all days</strong>.<img src="../../../../.gitbook/assets/image (569).png" alt=""></td></tr><tr><td><strong>Room</strong></td><td><p>Defines the <strong>room types</strong> to which the rule applies.</p><p>Room types must exist in:</p><p><strong>Hotel → Room Types</strong></p><p>Selecting <strong>Selected all</strong> means the rule applies to every configured room type.</p></td></tr><tr><td><strong>Board</strong></td><td>Board type filter. If the booking has a board, the system looks for a matching board rule first. If none exists, it can use a rule without board.</td></tr><tr><td><strong>From Age/to Age</strong></td><td>Defines the age interval for which the rule applies.</td></tr><tr><td><strong>Price</strong></td><td><p>Defines the <strong>discount value</strong> applied to the hotel cost. It can be set as a fixed price or as a percentage (it is divided by the number of stay days).</p><p> <img src="../../../../.gitbook/assets/01.07.2026_10.35.57_REC.png" alt="">  </p><p></p><p>Ex.1 (fixed price): </p><p>     Room Cost = 100 (total per stay)</p><p>     Stay days = 5</p><p>    EBD = 200 ⇒ Profit in booking = 100 - (200/5)</p><p>Ex.2 (percent price): </p><p>         EBD=10% </p><p>         Days = 5 </p><p>         PaxNo = 1</p><p>Scenario 1: RoomCost = 100/pax </p><p>                  TotalRoomCost = 100 </p><p>                  Final EBD = 10% * 100 = 10 </p><p>                  Final Cost = 100 - EBD = 100 - 10 = 90</p><p>Scenario 2: RoomCost= 20/Day </p><p>                  TotalRoomCost = 20 * Days = 100 </p><p>                  Final EBD = 10% * 100 = 10 </p><p>OR </p><p>                 Final EBD = 10% * 20 + 10% * 20 + 10% * 20 + 10% * 20 + 10% * 20 = 2 + 2 + 2 + 2 + 2 = 10 </p><p>                 Final Cost = 100 - EBD = 100 - 10 = 90</p></td></tr><tr><td><strong>BDNBA</strong></td><td><p>Defines whether the rule should consider <strong>booking days before arrival</strong>.</p><p>This value may be used together with booking date filters to restrict the rule based on how many days in advance the booking is made.</p></td></tr><tr><td><strong>IS %</strong></td><td>Treats <strong>Price</strong> as a percent of (Room Cost + Extra Included + Extra Bed + Stay &#x26; Pay). The result is subtracted.</td></tr><tr><td><strong>PR</strong></td><td><p>Defines whether the value is applied <strong>per room</strong> or <strong>per passenger</strong>.</p><ul><li>Enabled → discount applied <strong>per room</strong></li><li>Disabled → discount applied <strong>per passenger</strong></li></ul></td></tr><tr><td><strong>S&#x26;P</strong></td><td><p>Indicates whether the rule can <strong>combine with Stay and Pay Cost Rules</strong>.</p><p>If enabled, both rules may be applied during cost calculation.</p><p>Stay and Pay rules are configured under:</p><p><strong>Room Costs → Stay and Pay Cost Rules</strong></p></td></tr><tr><td><strong>EBC</strong></td><td>Apply on Extra Bed Cost</td></tr><tr><td><strong>BB</strong></td><td>Internal indicator used to identify rules that interact with board-based configurations.</td></tr><tr><td><strong>Min Days</strong></td><td><p>Defines the <strong>minimum number of days before arrival</strong> required for the rule to apply.</p><p>If a booking is created fewer days before arrival than defined here, the rule will not apply.</p></td></tr><tr><td><strong>Deposit Date</strong></td><td>The cutoff date for the deposit to be paid to validate the discount.</td></tr><tr><td><strong>DDNBA</strong></td><td>Defines the <strong>days before arrival</strong> used for deposit-related conditions.</td></tr><tr><td><strong>OB</strong></td><td>Applies on booking final save (deposit on booking).</td></tr><tr><td><strong>DEPOSIT %</strong></td><td>Discount percentage that applies for the deposit payment.</td></tr><tr><td><strong>Send List Date</strong></td><td>Date when the rate list or contract was sent, used for administrative tracking.</td></tr><tr><td><strong>SLDNBA</strong></td><td>Send list days number before arrival stay</td></tr><tr><td><strong>EBP Discount</strong></td><td>Customer Early Booking Discount</td></tr><tr><td><strong>Contract</strong></td><td><p>Displays the contract associated with the rule.</p><p>This helps identify the rule when multiple contracts exist for the same hotel.</p></td></tr><tr><td><strong>Invoice List</strong></td><td><p>Displays the invoice processing status for the rule.</p><p>The message <strong>“Rule not run by service”</strong> indicates that the background service responsible for applying the rule has not yet processed it.</p></td></tr></tbody></table>
