...
{% hint style="info" %}
Daily values typically come from your generated allotment periods. Set those on [Hotel allotments](../hotel-allotments/).
{% endhint %}
