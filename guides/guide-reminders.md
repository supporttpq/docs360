...
* Daily operational tasks (e.g., wake-up reminders, meeting times).
* Guest-related follow-up tasks.
* Internal communication within guide teams.
...
| Column              | Description                                                        |
| ------------------- | ------------------------------------------------------------------ |
| **From**            | The sender of the reminder.                                        |
| **To**              | The recipient guide or guide team.                                 |
| **Title**           | The short title or topic of the reminder.                          |
| **Submission Date** | The date/time when the reminder was created.                       |
...
1. **Status Filter** – Allows selecting:
   * _Show All_
   * _Accepted_
   * _Rejected_
2. **Guide Filter** – Filters reminders by sender or recipient guide.

After selecting filters, click **Display** to refresh results.
