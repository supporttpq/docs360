---
description: Add internal notes to a transport for context and traceability.
---
...
The **Notes** tab belongs to a specific transport configuration (example: _Billund → Tenerife_).
