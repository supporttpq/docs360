...
* Click on the **Add document** button on the right side of the **Documents** section.
...
* **Document**: Upload the file by either:
  * Clicking the upload area to browse and select a file.(Only PDF file are supported)
...
<figure><img src="../.gitbook/assets/test doc.png" alt=""><figcaption></figcaption></figure>
