...
| **STATUS**               | <p>Current processing status of the invoice:</p><ul><li><strong>Pending</strong> (yellow)</li><li><strong>Rejected</strong> (red)</li><li><strong>Approved</strong> (green)</li></ul> |
