...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/15.05.2026_14.52.19_REC.png" alt=""><figcaption></figcaption></figure></div>

*   At least one product in the package must be eligible for it to be selected.

    <div data-with-frame="true"><figure><img src="../../.gitbook/assets/15.05.2026_14.56.48_REC.png" alt=""><figcaption></figcaption></figure></div>
*   If you select the **package**, you cannot select the products inside the package as well. The system displays a warning message:

    <div data-with-frame="true"><figure><img src="../../.gitbook/assets/15.05.2026_14.54.13_REC.png" alt=""><figcaption></figcaption></figure></div>
*   If there are two products from the same category, and the category has multiple select enabled, both products apply.

    <div data-with-frame="true"><figure><img src="../../.gitbook/assets/15.05.2026_14.59.30_REC.png" alt=""><figcaption></figcaption></figure></div>
