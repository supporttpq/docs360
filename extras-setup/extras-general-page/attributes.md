...
<div data-with-frame="true"><figure><img src="../../.gitbook/assets/image (2) (1) (1) (2).png" alt=""><figcaption></figcaption></figure></div>
...
You can choose one or more attributes defined in [Extras Attributes](../../extras-attributes.md).
...
You can select a start day from the drop-down list in **Edit Passenger**. This requires an attribute and a value in the **Days** field under **Prices**.

For more information, see [Extras Attributes](../../extras-attributes.md).
...
* **Automatically Select Default Attribute Value**:\
  A checkbox that automatically applies a default attribute value during usage, such as booking or offer creation.
