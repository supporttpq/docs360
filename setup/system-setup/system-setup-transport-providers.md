...
| **Submit GDS reservation made in Tourpaq Office** | <p>If checked, GDS reservations made in Tourpaq Office will automatically be submitted. </p><p>The bookings made from web booking are always submitted.<br>(Note: This uses the SubmitGDS service).</p> |
