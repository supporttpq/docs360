...
| **Assign passengers to existing customers**                | This setting will assign new web bookings to an existing customer if a duplicate is found, prioritizing phone number first, email second, and name last.                                                      |
